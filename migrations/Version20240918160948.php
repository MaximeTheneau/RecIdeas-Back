 ...
 */
final class Version20240918160948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paragraph_posts_translation ADD CONSTRAINT FK_4A6449B6BDF81E77 FOREIGN KEY (posts_translation_id) REFERENCES posts_translation (id)');
