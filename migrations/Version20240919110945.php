 ...
 */
final class Version20240919110945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paragraph_posts_translation ADD CONSTRAINT FK_4A6449B6818985F6 FOREIGN KEY (paragraph_posts_id_id) REFERENCES paragraph_posts (id)');
