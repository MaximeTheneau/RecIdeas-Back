...
class Posts
{
    ...
    #[Groups(['api_posts_read', 'api_posts_all', 'api_posts_draft',  'api_posts_desc', 'api_posts_blog', 'api_posts_category', 'api_posts_keyword', 'api_posts_sitemap', 'api_posts_home' ])]
